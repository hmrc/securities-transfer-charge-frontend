...
import uk.gov.hmrc.securitiestransferchargefrontend.forms.$className$FormProvider
import uk.gov.hmrc.securitiestransferchargefrontend.models.{NormalMode, $className$, UserAnswers}
