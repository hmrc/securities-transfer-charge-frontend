...
class FrontendAppConfig @Inject() (configuration: Configuration, servicesConfig: ServicesConfig) {
  ...
  val alfStfBuyersContinueChangeUrl: String =
    s"$continueUrlBase/stf/change/address/return"
  
  val alfStfSellerContinueChangeUrl: String =
    s"$continueUrlBase/stf/change/seller/address/return"  
  ...
  val alfStfOrgContinueChangeUrl: String = s"$continueUrlBase/stf/org/change/address/return"

  val alfOrgSellerContinueUrl: String = s"$continueUrlBase/stf/org/seller/address/return"
  val alfOrgSellerContinueChangeUrl: String = s"$continueUrlBase/stf/org/change/seller/address/return"
