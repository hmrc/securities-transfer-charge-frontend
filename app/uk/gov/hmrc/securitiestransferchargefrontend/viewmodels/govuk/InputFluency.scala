...
package uk.gov.hmrc.securitiestransferchargefrontend.viewmodels.govuk
...
import uk.gov.hmrc.securitiestransferchargefrontend.viewmodels.{ErrorMessageAwareness, InputWidth}
