...
class BackwardsRoutes(defaultPage: Call):
  ...
  def normalRoutes(page: Page): Option[UserAnswers] => Call = page match {
    ...
    case ConnectedPersonsPage => _ => orgSingleRoutes.StfSellerAddressController.onPageLoad(NormalMode)
    ...
    case PurchasingSharesPage => _ => orgSingleRoutes.TaxRateController.onPageLoad(NormalMode)
    case OtherSecuritiesTypePage => _ => orgSingleRoutes.PurchasingSharesController.onPageLoad(NormalMode)
  ...
  private def checkRoutes(page: Page): Option[UserAnswers] => Call = page match {
    ...
    case TotalMarketValuePage => _ => orgSingleRoutes.PurchasingSharesController.onPageLoad(CheckMode)
    case AmountPaidForSecuritiesPage => _ => orgSingleRoutes.PurchasingSharesController.onPageLoad(CheckMode)
