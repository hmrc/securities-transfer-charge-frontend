...
import uk.gov.hmrc.securitiestransferchargefrontend.pages.stf.single.{AgentReferencePage, ConnectedPersonsPage, NameOfSellerPage, StfBuyersAddressPage, StfSellerAddressPage}
