...
class DetailsOfThisSharePurchaseController @Inject()(
                                      ...
                                      formProvider: DetailsOfThisSharePurchaseFormProvider,
                                      val controllerComponents: MessagesControllerComponents,
                                      view: DetailsOfThisSharePurchaseView
  ...
  def onPageLoad(mode: Mode): Action[AnyContent] = (stcAuthEnrolled andThen getData andThen requireData) {
    implicit request =>
      ...
      val preparedForm = request.userAnswers.get(DetailsOfThisSharePurchasePage) match {
        case None => form
