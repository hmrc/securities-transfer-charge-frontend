...
import uk.gov.hmrc.securitiestransferchargefrontend.pages.sh03.bulk.CannotSubmitFormErrorPage
import uk.gov.hmrc.securitiestransferchargefrontend.views.html.sh03.organisations.bulk.CannotSubmitFormErrorView

import javax.inject.{Inject, Named}

class CannotSubmitFormErrorController @Inject()(
                                                 ...
                                                 view: CannotSubmitFormErrorView
  ...
  def onPageLoad(): Action[AnyContent] = (stcAuthEnrolled andThen getData andThen requireData) {
    implicit request =>
      Ok(view(backLinkCall(NormalMode)(request.userAnswers)))
  }
}
