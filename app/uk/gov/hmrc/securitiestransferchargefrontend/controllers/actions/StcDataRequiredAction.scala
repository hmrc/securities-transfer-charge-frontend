...
trait StcDataRequiredAction
  extends ActionRefiner[StcOptionalDataRequest, StcDataRequest]

class StcDataRequiredActionImpl @Inject()()(implicit ec: ExecutionContext)
  ...
  override protected def refine[A](
    ...
    request.userAnswers match {
      case Some(answers) =>
        Future.successful(
          Right(StcDataRequest(request.request, answers))
        )
