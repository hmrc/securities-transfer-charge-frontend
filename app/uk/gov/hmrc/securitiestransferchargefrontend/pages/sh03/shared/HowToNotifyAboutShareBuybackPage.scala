...
case object HowToNotifyAboutShareBuybackPage extends QuestionPage[HowToNotifyAboutShareBuyback] {

  override def path: JsPath = JsPath \ toString

  override def toString: String = "howToNotifyAboutShareBuyback"
}
