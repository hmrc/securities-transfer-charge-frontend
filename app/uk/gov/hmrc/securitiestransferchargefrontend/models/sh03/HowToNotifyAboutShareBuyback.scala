...
sealed trait HowToNotifyAboutShareBuyback

object HowToNotifyAboutShareBuyback extends Enumerable.Implicits {

  case object OneAtATime extends WithName("oneAtATime") with HowToNotifyAboutShareBuyback
  case object MoreThanOneAtATime extends WithName("moreThanOneAtATime") with HowToNotifyAboutShareBuyback

  val values: Seq[HowToNotifyAboutShareBuyback] = Seq(
  ...
  implicit val enumerable: Enumerable[HowToNotifyAboutShareBuyback] =
