...
class PersistentNavigationHelperSpec extends SpecBase with MockitoSugar with ScalaFutures {
  ...
  private val emptyUserAnswers = UserAnswers.empty(testUserId)(testGroupIdentifier)(submissionId)(STF)
  ...
  private val testCall = individualsRoutes.HowToNotifyAboutSecuritiesTransferController.onPageLoad()
