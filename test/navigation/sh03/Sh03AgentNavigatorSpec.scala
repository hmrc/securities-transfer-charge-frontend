...
import uk.gov.hmrc.securitiestransferchargefrontend.models.sh03.agents.{CompanyDetails, RoleAtPurchasingCompany}
import uk.gov.hmrc.securitiestransferchargefrontend.models.sh03.shared.{DetailsOfThisSharePurchase, ReasonForPurchase}
