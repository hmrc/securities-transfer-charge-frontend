...
import uk.gov.hmrc.securitiestransferchargefrontend.pages.stf.individuals.single.{ApplyingForReliefPage, ChargingPointPage, ConfirmAddressPage, ConnectedPersonsPage, NameOfSellerPage, SecuritiesTargetPage, StfBuyersAddressPage, StfSellerAddressPage, TaxRatePage, WhatReliefAreYouApplyingForPage}
