...
class TotalMarketValueFormProviderSpec extends CurrencyFieldBehaviours {
  ...
  ".value" - {
    ...
    behave like currencyField(
      form,
      fieldName,
      nonNumericError     = FormError(fieldName, "org.totalMarketValue.error.nonNumeric"),
      invalidNumericError = FormError(fieldName, "org.totalMarketValue.error.invalidNumeric")
    )
    ...
    behave like currencyFieldWithMaximum(
      ...
      fieldName,
      maximum,
      FormError(fieldName, "org.totalMarketValue.error.aboveMaximum", Seq(currencyFormat(maximum)))
    )

    behave like mandatoryField(
      form,
      fieldName,
      requiredError = FormError(fieldName, "org.totalMarketValue.error.required")
    )
  }
}
