...
package forms.sh03.agents.bulk
...
class CompanyDetailsFormProviderSpec extends StringFieldBehaviours {
  ...
  ".companyName" - {
    ...
    val requiredKey = "agent.sh03.bulk.companyDetails.companyName.error.required"
    val lengthKey = "agent.sh03.bulk.companyDetails.companyName.error.length"
    val maxLength = 160
  ...
  ".companyRegistrationNumber" - {
    ...
    val requiredKey = "agent.sh03.bulk.companyDetails.crn.error.required"
    val invalidKey = "agent.sh03.bulk.companyDetails.crn.error.invalid"
    val lengthKey = "agent.sh03.bulk.companyDetails.crn.error.length"
