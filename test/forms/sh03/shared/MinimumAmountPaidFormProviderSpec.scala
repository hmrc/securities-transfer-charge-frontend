    ...
    affinityKeys.foreach { key =>
      ...
      s"when affinityKey is $key" - {
        ...
        behave like currencyField(
          ...
          fieldName,
          nonNumericError =
            FormError(fieldName, s"$key.sh03.minimumAmountPaid.error.nonNumeric"),
          invalidNumericError =
            FormError(fieldName, s"$key.sh03.minimumAmountPaid.error.invalidNumeric")
        )
        ...
        behave like currencyFieldWithMaximum(
          ...
          FormError(
            fieldName,
            s"$key.sh03.minimumAmountPaid.error.aboveMaximum",
        ...
        behave like mandatoryField(
          ...
          fieldName,
          requiredError =
            FormError(fieldName, s"$key.sh03.minimumAmountPaid.error.required")
        )
