  ...
  "EmptyFileErrorView" - {
    ...
    "when rendered" - {
      ...
      "must have the download link" in {
        ...
        link.attr("href") mustBe "/securities-transfer-charge/assets/Bulk_Securities_Transfer_Charge_template_v1b.xlsx"
        link.attr("download") mustBe "Bulk Securities Transfer Charge template v1b.xlsx"
      }
