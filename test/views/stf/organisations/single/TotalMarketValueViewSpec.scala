...
import uk.gov.hmrc.securitiestransferchargefrontend.views.html.stf.organisations.single.TotalMarketValueView
...
class TotalMarketValueViewSpec extends ViewBaseSpec {
  ...
  object ExpectedContent {
    val title: String = messages("org.totalMarketValue.title")
    val caption: String = messages("transfer.details.caption")
    val heading: String = messages("org.totalMarketValue.heading")
    val hint: String = messages("org.totalMarketValue.hint")
