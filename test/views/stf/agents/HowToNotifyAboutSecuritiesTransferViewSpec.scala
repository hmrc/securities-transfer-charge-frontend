...
class HowToNotifyAboutSecuritiesTransferViewSpec extends ViewBaseSpec {
  ...
  object ExpectedContent {
    val title: String = messages("agent.howToNotifyAboutSecuritiesTransfer.title")
    val caption: String = messages("transfer.details.caption")
    val heading: String = messages("agent.howToNotifyAboutSecuritiesTransfer.heading")
