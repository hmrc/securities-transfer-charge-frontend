...
import uk.gov.hmrc.securitiestransferchargefrontend.views.html.stf.agents.single.SecuritiesTargetView
...
class SecuritiesTargetViewSpec extends ViewBaseSpec {
  ...
  object ExpectedContent {
    val title: String = messages("agent.securitiesTarget.title")
    val heading: String = messages("agent.securitiesTarget.heading")
    val caption: String = messages("transfer.details.caption")
    val field1: String = messages("agent.securitiesTarget.businessName")
    val field2: String = messages("agent.securitiesTarget.crn")
    val crnHintMessage1: String = messages("agent.securitiesTarget.crn.hint")
