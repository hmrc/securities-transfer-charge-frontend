...
class AmountPaidForSecuritiesViewSpec extends ViewBaseSpec {
  ...
  object ExpectedContent {
    val title: String = messages("agent.amountPaidForSecurities.title")
    val heading: String = messages("agent.amountPaidForSecurities.heading")
    val caption: String = messages("transfer.details.caption")
    val p1: String = messages("agent.amountPaidForSecurities.p1")
    val p2: String = messages("agent.amountPaidForSecurities.p2")
