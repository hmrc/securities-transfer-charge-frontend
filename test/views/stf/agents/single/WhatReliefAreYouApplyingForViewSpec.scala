...
import uk.gov.hmrc.securitiestransferchargefrontend.forms.stf.agents.WhatReliefAreYouApplyingForFormProvider
...
class WhatReliefAreYouApplyingForViewSpec extends ViewBaseSpec {
  ...
  object ExpectedContent {
    val title: String = messages("agent.whatReliefAreYouApplyingFor.title")
    val caption: String = messages("transfer.details.caption")
    val heading: String = messages("agent.whatReliefAreYouApplyingFor.heading")
