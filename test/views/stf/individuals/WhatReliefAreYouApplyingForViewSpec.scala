...
class WhatReliefAreYouApplyingForViewSpec extends ViewBaseSpec {
  ...
  object ExpectedContent {
    val title: String = messages("whatReliefAreYouApplyingFor.title")
    val caption: String = messages("transfer.details.caption")
    val heading: String = messages("whatReliefAreYouApplyingFor.heading")
    val paragraph: String = messages("whatReliefAreYouApplyingFor.p")
