...
class ConnectedPersonsViewSpec extends ViewBaseSpec {
  ...
  object ExpectedContent {
    val title: String = messages("agent.sh03.connectedPersons.title")
    val heading: String = messages("agent.sh03.connectedPersons.heading")
    val para: String = messages("agent.sh03.connectedPersons.p")
    val legend: String = messages("agent.sh03.connectedPersons.legend")
