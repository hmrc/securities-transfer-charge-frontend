...
class TemplateInstructionsViewSpec extends ViewBaseSpec {
  ...
  def view(): Document = Jsoup.parse(
    viewInstance(CommonHelpers.linkToTemplateFor(SH03)(orgAffinity))(fakeRequest, messages).body
  )

  object ExpectedContent {
    val title: String = messages("org.sh03.templateInstructions.title")
    val heading: String = messages("org.sh03.templateInstructions.heading")
    ...
    val para2Value: String = messages("org.sh03.templateInstructions.p2")
    val para3Value: String = messages("org.sh03.templateInstructions.p3")
