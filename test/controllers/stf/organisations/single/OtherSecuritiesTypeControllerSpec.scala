...
import uk.gov.hmrc.securitiestransferchargefrontend.views.html.stf.organisations.single.OtherSecuritiesTypeView
...
class OtherSecuritiesTypeControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val otherSecuritiesTypeRoute: String = orgSingleRoutes.OtherSecuritiesTypeController.onPageLoad(NormalMode).url
  ...
  "OtherSecuritiesType Controller" - {
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        redirectLocation(result).value mustEqual orgSingleRoutes.AmountPaidForSecuritiesController.onPageLoad(NormalMode).url
      }
    }
