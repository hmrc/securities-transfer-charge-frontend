...
class ConnectedPersonsControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val connectedPersonsRoute: String = orgSingleRoutes.ConnectedPersonsController.onPageLoad(NormalMode).url
  ...
  "ConnectedPersons Controller" - {
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        redirectLocation(result).value mustEqual orgSingleRoutes.ApplyingForReliefController.onPageLoad(NormalMode).url
      }
    }
