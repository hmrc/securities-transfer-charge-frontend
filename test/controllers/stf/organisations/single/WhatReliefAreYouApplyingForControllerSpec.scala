...
import uk.gov.hmrc.securitiestransferchargefrontend.views.html.stf.organisations.single.WhatReliefAreYouApplyingForView
...
class WhatReliefAreYouApplyingForControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val whatReliefAreYouApplyingForRoute: String = orgSingleRoutes.WhatReliefAreYouApplyingForController.onPageLoad(NormalMode).url
  ...
  "WhatReliefAreYouApplyingFor Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(testUserId, testGroupIdentifier, submissionId,STF).set(WhatReliefAreYouApplyingForPage, "answer").success.value
