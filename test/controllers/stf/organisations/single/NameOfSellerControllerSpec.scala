...
import uk.gov.hmrc.securitiestransferchargefrontend.pages.stf.individuals.single.NameOfSellerPage
  ...
  "NameOfSeller Controller" - {
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        redirectLocation(result).value mustEqual orgSingleRoutes.StfSellerAddressController.onPageLoad().url
      }
    }
