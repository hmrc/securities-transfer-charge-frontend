...
class NameOfSellerControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val nameOfSellerRoute: String = orgRoutes.NameOfSellerController.onPageLoad(NormalMode).url
  ...
  "NameOfSeller Controller" - {
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        redirectLocation(result).value mustEqual orgRoutes.StfSellerAddressController.onPageLoad(NormalMode).url
      }
    }
