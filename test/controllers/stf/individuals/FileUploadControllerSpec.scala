...
class FileUploadControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val fileUploadRoute: String = individualRoutes.FileUploadController.onPageLoad().url
  lazy val onUploadErrorRoute: String = individualRoutes.FileUploadController.onUploadError().url
  val reference = "file1"
